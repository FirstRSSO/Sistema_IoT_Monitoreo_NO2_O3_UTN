...
## 12. Authorship and license

**Author:** *[Full name of the author]*
**Advisor:** *[Name of the thesis advisor]*
**Program:** *[Degree program]* — Facultad de Ingeniería en Ciencias Aplicadas (FICA)
**Institution:** Universidad Técnica del Norte — Ibarra, Ecuador
**Year:** 2025
...
@thesis{monitoreo_no2_o3_utn,
  ...
  year        = {2025},
  url         = {https://github.com/FirstRSSO/Sistema_IoT_Monitoreo_NO2_O3_UTN}
}
```
---

<div align="center">
<sub>Developed as an undergraduate thesis at Universidad Técnica del Norte · Ibarra, Ecuador</sub>
</div>
